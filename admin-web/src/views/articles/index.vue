...
const handleAdd = () => { form.value = { title: '', content: '' }; dialogVisible.value = true }
...
const handleSubmit = async () => {
  if (form.value.id) await request.put(`/articles/${form.value.id}/`, form.value)
  else await request.post('/articles/', form.value)
...
<template>
  <div class="articles-page">
    <div class="header"><h2>内容管理</h2><el-button type="primary" @click="handleAdd">发布文章</el-button></div>
